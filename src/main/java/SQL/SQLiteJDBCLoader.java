...
public class SQLiteJDBCLoader {
     ...
     * otherwise. Deleted old native libraries e.g. on Windows the DLL file is
     * not removed on VM-Exit (bug #80)
     */
    static void cleanup() {
     ...
     *
     * @return True if the SQLite JDBC driver is set to native Java mode; false
     * otherwise.
     */
